...
## I'm an AI Infrastructure Engineer & O'Reilly Author

- 🏗️ Building production AI systems with observability, reliability, and performance at scale.
- 📚 Author of [Prompt Engineering for LLMs](https://www.oreilly.com/library/view/prompt-engineering-for/9781098153427/) (O'Reilly).
- 👨‍🏫 Taught 306K+ developers and delivered 45+ bootcamps on AI/ML and software engineering.
- 🔧 Specializing in LLM engineering, RAG systems, fine-tuning, and full-stack development.
- 💼 Open to opportunities in AI/ML infrastructure and engineering roles.
- 💬 Ask me about: production AI systems, LLM engineering, and scaling ML infrastructure.
